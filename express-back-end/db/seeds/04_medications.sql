INSERT INTO medications (name, nickname, user_id, prescribed_date, pharmacy_id, prescribed_doctor_id, refills_remaining, instructions, is_take_with_water, is_take_with_food)
                 VALUES ('Warfarin', 'Blood Clots', 1, '2021-01-15', 1, 2, 0, 'Take once per day, with or without food.', FALSE, TRUE),
                        ...
                        ('Tylenol-Codeine NO.3', 'Pain Killers', 1, '2021-04-20', 5, 3, 0, 'If nauseous, it may help to take with food', TRUE, TRUE);